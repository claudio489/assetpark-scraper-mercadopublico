...
exports.BUSINESS_CRITERIA = void 0;
exports.calculateBusinessScore = calculateBusinessScore;
exports.analyzeCompetition = analyzeCompetition;
exports.calculateAnalyticScore = calculateAnalyticScore;
// Criterios de negocio por rubro (en CLP)
exports.BUSINESS_CRITERIA = {
 ...
 */
function calculateBusinessScore(amount, criteria) {
    const reasons = [];
    let score = 50; // Base
    if (amount === 0) {
 ...
 */
function analyzeCompetition(adjudicated, organismoName) {
    const reasons = [];
 ...
 */
function calculateAnalyticScore(baseScore, amount, profileId, historicalPattern) {
    const criteria = exports.BUSINESS_CRITERIA[profileId] || exports.BUSINESS_CRITERIA.general;
    ...
    const finalScore = Math.round(baseScore * 0.40 +
        biz.score * 0.35 +
