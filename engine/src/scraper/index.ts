 ...
 */
const MOCK_DATABASE: RawOpportunity[] = [
  {
    codigo: 'LIC-2024-001',
 ...
 */
export async function scrapeOpportunities(options?: { sources?: string[]; limit?: number }): Promise<RawOpportunity[]> {
...
const SOURCE_REGISTRY: Record<string, () => Promise<RawOpportunity[]>> = {
